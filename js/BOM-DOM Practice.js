...
toggleClassBtn.addEventListener(("click", function(e){
    ...
    if(targetBox.getAttribute("class")){
        targetBox.getAttribute("class", 'toggleClass2')
    }
})
...
theBox.addEventListener(("mouseenter", function(){
  console.log("I entered the Box!") ;
    displayBoxInfo.InnerText = "Box entered!"
})
    theBox.addEventListener("mouseleave", function(){
        console.log("I exited the Box!");
        displayBoxInfo.InnerText = "Box entered!"
    })
